...
module OpenPGP
  ...
  PGP_STATUS_SUCCESS = Success
  PGP_STATUS_UNKNOWN_ERROR = UnknownError
  PGP_STATUS_NETWORK_POLICY_VIOLATION = NetworkPolicyViolation
  PGP_STATUS_IO_ERROR = IOError
  PGP_STATUS_INVALID_ARGUMENT = InvalidArgument
  PGP_STATUS_INVALID_OPERATION = InvalidOperation
  PGP_STATUS_MALFORMED_PACKET = MalformedPacket
  PGP_STATUS_UNSUPPORTED_PACKET_TYPE = UnsupportedPacketType
  PGP_STATUS_UNSUPPORTED_HASH_ALGORITHM = UnsupportedHashAlgorithm
  PGP_STATUS_UNSUPPORTED_PUBLIC_KEY_ALGORITHM = UnsupportedPublicKeyAlgorithm
  PGP_STATUS_UNSUPPORTED_ELLIPTIC_CURVE = UnsupportedEllipticCurve
  PGP_STATUS_UNSUPPORTED_SYMMETRIC_ALGORITHM = UnsupportedSymmetricAlgorithm
  PGP_STATUS_UNSUPPORTED_AEAD_ALGORITHM = UnsupportedAEADAlgorithm
  PGP_STATUS_UNSUPPORTED_COMPRESSION_ALGORITHM = UnsupportedCompressionAlgorithm
  PGP_STATUS_UNSUPPORTED_SIGNATURE_TYPE = UnsupportedSignatureType
  PGP_STATUS_INVALID_PASSWORD = InvalidPassword
  PGP_STATUS_INVALID_SESSION_KEY = InvalidSessionKey
  PGP_STATUS_MISSING_SESSION_KEY = MissingSessionKey
  PGP_STATUS_MALFORMED_CERT = MalformedCert
  PGP_STATUS_MALFORMED_MPI = MalformedMPI
  PGP_STATUS_BAD_SIGNATURE = BadSignature
  PGP_STATUS_MANIPULATED_MESSAGE = ManipulatedMessage
  PGP_STATUS_MALFORMED_MESSAGE = MalformedMessage
  PGP_STATUS_INDEX_OUT_OF_RANGE = IndexOutOfRange
  PGP_STATUS_UNSUPPORTED_CERT = UnsupportedCert
  PGP_STATUS_EXPIRED = Expired
  PGP_STATUS_NOT_YET_LIVE = NotYetLive
